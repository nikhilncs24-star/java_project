...
public class Customer {
    ...
    public double getRoomBill(double pricePerDay) {
        return stayDays * pricePerDay;
    }

    public double getGrandTotal(double pricePerDay) {
        return getRoomBill(pricePerDay) + getFoodBill();
    }
}
